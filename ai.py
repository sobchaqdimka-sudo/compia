...
def update_memory(previous_facts, recent_messages):
    ...
    prompt = (
        ...
        "Обязательно сохраняй важные совместные моменты и договорённости: что вы "
        "вместе делали, что 'смотрели' или обсуждали, о чём договорились - чтобы "
        "потом можно было об этом вспомнить. "
        "Пиши по пунктам, очень кратко, до ~12 пунктов, только то, что важно помнить "
        "надолго. Старое и неактуальное убирай, не раздувай список. Не выдумывай "
