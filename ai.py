        ...
        system_blocks.append(
            {
                ...
                "text": (
                    ...
                    "с тобой история до этого момента - НЕ начинай заново «расскажи о "
                    "себе», он уже что-то рассказал; тепло, живо и чуть игриво среагируй "
                    "на то, что ты как бы слышала из разговора (одна-две короткие реплики, "
                    "в характере). НЕ задавай ему системных вопросов («сколько тебе "
                    "лет», «как тебя зовут», «18+?»): всё, что нужно, система уже "
                    "учла. Отвечай на языке собеседника. Ненавязчиво дай понять, что "
                    "роль можно сменить в любой момент - но без громких объявлений."
                ),
            }
        )
