        ...
        system_blocks.append(
            {
                "type": "text",
                "text": (
                    "Это твоё первое сообщение в новой роли. У собеседника, возможно, "
                    "уже есть с тобой история до этого момента. Если она есть - НЕ "
                    "начинай заново «расскажи о себе», он уже что-то рассказал; тепло "
                    "среагируй на то, что ты как бы услышала, коротко представься и "
                    "продолжи в новой роли. Если истории нет - живое первое "
                    "представление в характере. Отвечай на языке собеседника, без "
                    "анкет и громких объявлений. Ненавязчиво дай понять, что роль "
