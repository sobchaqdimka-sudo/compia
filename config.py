...
# Модель Anthropic для основных ответов. Haiku 4.5 — дешевле и быстрее.
# Для более тонкой эмоции/ролёвки можно вернуть "claude-sonnet-4-6".
MODEL = "claude-haiku-4-5"

# Некоторым персонам нужна более «умная» модель: тоньше эмоция, лучше украинский,
# меньше ошибок связности. Переопределяем модель по персоне; остальные берут MODEL.
PERSONA_MODELS = {
